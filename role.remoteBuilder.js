var roleRemoteBuilder = {
    ...
    run: function(creep) {
		...
		//Now for the fun part of getting minerals from a node, 
			...
			var closestConstructionSite = creep.pos.findClosestByPath(FIND_CONSTRUCTION_SITES, {filter: (ConstructionSite) => { return (ConstructionSite.structureType == STRUCTURE_ROAD) || (ConstructionSite.structureType == STRUCTURE_RAMPART)  || (ConstructionSite.structureType == STRUCTURE_TERMINAL) || (ConstructionSite.structureType == STRUCTURE_TOWER) || (ConstructionSite.structureType == STRUCTURE_STORAGE) || (ConstructionSite.structureType == STRUCTURE_CONTAINER) || (ConstructionSite.structureType == STRUCTURE_EXTENSION) || (ConstructionSite.structureType == STRUCTURE_SPAWN) }}, closestConstructionSitePos);
